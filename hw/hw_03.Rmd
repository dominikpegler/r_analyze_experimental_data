...
22 People for the condition with small cue size.
...
440.4 valid trials per person in the small cue size condition are necessary in order to reach 90% power to detect an effect of 20 ms
